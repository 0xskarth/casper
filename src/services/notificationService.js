// ========================================
// NOTIFICATION SERVICE - CSV Update Notifications
// ========================================
...
const { normalizeBSCFileName } = require('../utils/helpers');

class NotificationService {
    constructor(client, notificationChannelId) {
        this.client = client;
        this.notificationChannelId = notificationChannelId;
    }

    async notifyListUpdate(fileName, action = 'updated') {
        try {
